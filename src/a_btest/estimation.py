...
class ABTEST:
    ...
    def generate_plot(self,click="One-sided Test") -> plt:
        ...
        plt.fill_between(x, H0_distribution, where=(x > z_alpha), color='blue', alpha=0.5, label='Type I Error (α)')
        plt.fill_between(x, MDE_distribution, where=(x < z_beta), color='green', alpha=0.5, label='Type II Error β')
